...
see that the missing measurements have actual values when the variable
...
transformed tidy covariates / Level 2 covariates. In the interest of letting
...
For pedagogical reasons, I'll implement my own out-of-sample estimate, using 
the reserved validation data.  The concept here is that since I don't have 
access to the test data, I estimate the error on the test set using training 
data which was separated out before building the model.
...
## Conclusions
* Complex and a simple fandom forest models were built; both achieved 
